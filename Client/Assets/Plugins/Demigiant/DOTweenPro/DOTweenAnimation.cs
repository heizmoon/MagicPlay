...
//            }
            ...
            case AnimationType.UIWidthHeight:
                ...
                break;
            case AnimationType.AnchorPos3D:
                tween = ((RectTransform)target).DOAnchorPos3D(endValueV3, duration, optionalBool0);
                break;
#endif
...
//            if (str == "RectTransform") str = "Transform";
        ...
        void ReEvaluateRelativeTween()
        {
            ...
            } else if (animationType == AnimationType.AnchorPos3D) {
                ((Tweener)tween).ChangeEndValue(tweenGO.GetComponent<RectTransform>().anchoredPosition3D + endValueV3, true);
            }
        }
